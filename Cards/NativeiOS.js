...
import Nativeios from '../assets/images/NativeIOS.b45dbf50.svg'




class NativeiOSCard extends React.Component{
    constructor(){
        super()
        this.state={
            show:false,
       ...
       return(
        ...
        <View style={{ flex:1,}}>
         <TouchableOpacity style={styles.Card} activeOpacity={0.7} onPress={() => {this.setState({show:true})}}>
            <Nativeios size={10}/>
            <Text style={{ fontSize:15, color:COLORS.blue, }}>Native IOS</Text>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',marginLeft:20,marginTop:10}}>
              <View>
                ...
                <Text style={{ fontSize:26,color:'#040622',fontWeight:'bold'}}>Native IOS</Text>
               </View>

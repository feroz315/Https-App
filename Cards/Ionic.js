...
import Ionic from '../assets/images/Ionic.0ec87505.svg';




class IonicCard extends React.Component{
    constructor(){
        super()
        this.state={
            show:false,
       ...
       return(
        ...
        <View style={{ flex:1,}}>
         <TouchableOpacity style={styles.Card} activeOpacity={0.7} onPress={() => {this.setState({show:true})}}>
            <Ionic marginTop={15}/>
            <Text style={{ fontSize:15, color:COLORS.blue }}>ionic</Text>
            ...
            <View style={{ flex:0.50,marginTop:10}}>
             ...
             visible={ this.state.show }>
              ...
              <View style={{flex:1}}>
                <View style={{ backgroundColor:COLORS.green,marginTop:240,margin:15, borderRadius:25,flex:1 }}>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',marginLeft:20,marginTop:10}}>
              <View>
                ...
                <Text style={{ fontSize:26,color:'#040622',fontWeight:'bold'}}>Ionic</Text>
               </View>

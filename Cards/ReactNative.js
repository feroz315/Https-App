...
import ReactNative from '../assets/images/ReactNative.f7eae01f.svg';
       ...
       return(
        ...
        <View style={{ flex:1,}}>
         <TouchableOpacity style={styles.Card} activeOpacity={0.7} onPress={() => {this.setState({show:true})}}>
            <ReactNative marginTop={15}/>
            <Text style={{ fontSize:15, color:COLORS.blue }}>React Native</Text>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',marginLeft:20,marginTop:10}}>
              <View>
                ...
                <Text style={{ fontSize:26,color:'#040622',fontWeight:'bold'}}>React Native</Text>
               </View>

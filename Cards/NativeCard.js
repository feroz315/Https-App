...
import NativeAndroid from '../assets/images/NativeAndroid.543665a9.svg';
       ...
       return(
        ...
        <View style={{ flex:1,}}>
         <TouchableOpacity style={styles.Card} activeOpacity={0.7} onPress={() => {this.setState({show:true})}}>
            <NativeAndroid marginTop={15}/>
            <Text style={{ fontSize:15, color:COLORS.blue }}>Native Android</Text>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',marginLeft:20,marginTop:10}}>
              <View>
                ...
                <Text style={{ fontSize:26,color:'#040622',fontWeight:'bold'}}>Native Android</Text>
               </View>

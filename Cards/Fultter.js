...
import Fultter from '../assets/images/Flutter.692a0b98.svg';



class FultterCards extends React.Component{
    constructor(){
        super()
        this.state={
            show:false,
       ...
       return(
        ...
        <View style={{ flex:1,}}>
         <TouchableOpacity style={styles.Card} activeOpacity={0.7} onPress={() => {this.setState({show:true})}}>
            <Fultter marginTop={15}/>
            <Text style={{ fontSize:15, color:COLORS.blue}}>Flutter</Text>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'flex-end',marginLeft:20,marginTop:10}}>
              <View>
                ...
                <Text style={{ fontSize:26,color:'#040622',fontWeight:'bold'}}>Fultter</Text>
               </View>
